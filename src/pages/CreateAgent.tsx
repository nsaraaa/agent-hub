...
import { Plus, Upload, Shield, Settings, Link, Trash2 } from "lucide-react";
      ...
      <div className="border-b border-border bg-card">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-semibold text-foreground tracking-tight">Create Agent</h1>
              <p className="text-muted-foreground mt-2">Configure and deploy intelligent agents for your applications</p>
            </div>
            <div className="flex items-center space-x-3">
              <Button variant="outline" className="border-border">Save as Draft</Button>
              <Button className="bg-primary hover:bg-primary-hover text-primary-foreground">Deploy Agent</Button>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-8 mt-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-muted-foreground">
                Add knowledge base and guardrails
              </span>
            </div>
          </div>
        </div>
